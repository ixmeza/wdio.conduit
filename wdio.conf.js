...
exports.config = {
    ...
    suites: {
        articles: [
            './test/specs/createpost.spec.js',
            './test/specs/editarticle.spec.js',
            './test/specs/deletearticle.spec.js',
            './test/specs/favarticle.spec.js'
        ],
        login: [
    ...
    reporters: [
        ...
        ['junit', {
            ...
            outputFileFormat: function(options) { // optional
                return `results-${options.suite}.${options.capabilities.browserName}.xml`
            }
        }]
    ],
